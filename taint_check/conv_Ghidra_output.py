...
filter_chr="%$"
def main(filename=None, from_file=True):
    if from_file:
        if filename==None:
            filename=sys.argv[1]
        ...
        cont = '[Param "ddns_domain_ip"(0x0046b68c), Referenced at FUN_0042657c : 0x0042e2e4] >> 0x0042e334 >> FUN_0040fc28 >> 0x0040fca0 -> <EXTERNAL>::strcpy'

...
class FrontAnalysise(_BaseAnalysise):
    ...
    def analysise(self, ANALYSIZER):
        ...
        for suffix, parser in ANALYSIZER.items():
            self.log.warning (" Start Analysise {} File".format(suffix))
            ...
            # files = ["/home/cui2shark/firmware/research/satc/src/firmwares/totolink-3002r-B20200824.0128/squashfs-root/web/password.htm"]
    ...
    def crosser_analysise(self, ANALYSIZER):
...
class BackAnalysise(_BaseAnalysise):
    ...
    def crosser_analysise(self):
        ...
        for elf in elfs:
            ...
            self.effective_function = self.effective_function + elf_function_res
            self.effective_ upnpkeyword = self.effective_upnpkeyword + elf_upnp_keyword_res
            self.effective_keyword = self.effective_keyword + elf_keyword_res
        ...
        self.effective_function = list(set(function_set))
        self.effective_keyword = list(set(args_set))
        self.effective_upnpkeyword = list(set(upnp_args_set))
